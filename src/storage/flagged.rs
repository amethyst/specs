...
///
/// What you want to instead is to use `check()` or `restrict_mut()` to first
...
///
///         // Or alternatively:
///         for (entity, mut comps_deferred) in (&*entities, &mut comps.restrict_mut()).join() {
///             if true { // check whether this component should be modified.
///                  let mut comp = comps_deferred.get_mut_unchecked();
///                  // ...
///             }
///         }
///
